...
\graphicspath{{paper/figures/}{outputs/evaluation/figures/}}
...
configuration or plugins but not a first-class workflow.
...
Figure~\ref{fig:ui} shows the mission preparation view.

\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{mission_costmap_ui.png}
\caption{Mission interface with ordered targets, routing controls, a manually
defined forbidden zone, route status, and export controls.}
\label{fig:ui}
\end{figure}
...
\centering
\small
\input{outputs/evaluation/paper_results.tex}
\end{table*}
