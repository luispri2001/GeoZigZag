...
% Compile correctly in either supported layout:
%   1) repository root with paper/main.tex as the main document; or
%   2) the contents of paper/ uploaded as an independent Overleaf project.
\graphicspath{{figures/}{figures/generated/}{paper/figures/}{paper/figures/generated/}}
\newcommand{\paperinput}[1]{%
  \IfFileExists{generated/#1}{\input{generated/#1}}{\input{paper/generated/#1}}%
}
...
\centering
\scriptsize
\paperinput{paper_coverage_results.tex}
\end{table}
